...
def image_119_rec(image_numpy, image_path):
    ...
    mean_str = [str(round(np.mean(image_numpy[112:112+20, 25:25+18]),2)), str(round(np.mean(image_numpy[8:8+25, 100:100+25]),2))]
    std_str = [str(round(np.std(image_numpy[112:112+20, 25:25+18]),2)), str(round(np.std(image_numpy[8:8+25, 100:100+25]),2))]

    return mean_str, std_str

def image_201_rec(image_numpy, image_path):
    # print('A')
    plt.clf()
    plt.imshow(np.squeeze(image_numpy), cmap=plt.cm.bone)
    currentAxisA = plt.gca()
    ...
    mean_str = [str(round(np.mean(image_numpy[12:12+25, 25:25+30]),2)), str(round(np.mean(image_numpy[173:173+15, 138:138+20]),2))]
    std_str = [str(round(np.std(image_numpy[12:12+25, 25:25+30]),2)), str(round(np.std(image_numpy[173:173+15, 138:138+20]),2))]

    return mean_str, std_str

def image_506_rec(image_numpy, image_path):
    # print('A')
    plt.clf()
    plt.imshow(np.squeeze(image_numpy), cmap=plt.cm.bone)
    currentAxisA = plt.gca()
    ...
    mean_str = [str(round(np.mean(image_numpy[142:142+20, 20:20+25]),2)), str(round(np.mean(image_numpy[105:105+15, 40:40+25]),2))]
    std_str = [str(round(np.std(image_numpy[142:142+20, 20:20+25]),2)), str(round(np.std(image_numpy[105:105+15, 40:40+25]),2))]
...
experiment_name = "decouple_cb200_cyclegan4_iter50_batch2"
# "twnp200_cyclegan_iter50_batch2"
# "twnp200c_cyclegan4cl_batch2"
# "decouple_cb200_cyclegan4_iter50_batch2" "twnp200c_cyclegan4c_batch2"
...
for image in image_201_names:
    ...
    [mean_str, std_str] = image_201_rec(np.load(npy_path), image_path)
    print("mean: " + ",".join(mean_str))
    print("std: " + ",".join(std_str))
...
for image in image_506_names:
    ...
    [mean_str, std_str] = image_506_rec(np.load(npy_path), image_path)
    print("mean: " + ",".join(mean_str))
    print("std: " + ",".join(std_str))
