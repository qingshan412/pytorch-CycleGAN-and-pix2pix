...
python test_ct_2.py --dataroot ./datasets/tw_np_200 --name twnp200_cyclegan_batch2 --model cycle_gan --serial_batches
#####################################Fake_train
...
python train_ct.py --dataroot ./datasets/decouple_AC200 --name decouple_ac200_cyclegan_batch2 --model cycle_gan --batch_size 2 --niter 25 --niter_decay 25 --display_id -1 > rec/decouple_ac200_cyclegan_batch2_html_rec
python train_ct.py --dataroot ./datasets/decouple_CB200 --name decouple_cb200_cyclegan_batch2 --model cycle_gan --batch_size 2 --niter 25 --niter_decay 25 --display_id -1 > rec/decouple_cb200_cyclegan_batch2_html_rec
# python test_ct_2.py --dataroot ./datasets/decouple_AC200 --name decouple_ac200_cyclegan_batch2 --model cycle_gan --serial_batches
