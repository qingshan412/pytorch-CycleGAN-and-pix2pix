...
python test_ct_3.py --dataroot ./datasets/tw_np_200 --name twnp200c_cyclegan4cc_batch2 --dataset_mode unalignedC --model cycle_gan_cc --netG resnet_4blocks --serial_batches
